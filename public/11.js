...
/***/ "./resources/js/components/TooltipItem.js":
/*!************************************************!*\
  !*** ./resources/js/components/TooltipItem.js ***!
  \************************************************/
...
function (_React$Component) {
  ...
  _createClass(TooltipItem, [{
    ...
    value: function render() {
      ...
      }, item.text), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["Tooltip"], {
        placement: item.placement,
        isOpen: tooltipOpen,
        target: "Tooltip-".concat(id),
        toggle: this.toggle
      }, "Tooltip Content!"));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (TooltipItem);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var reactstrap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! reactstrap */ "./node_modules/reactstrap/es/index.js");
/* harmony import */ var _components_TooltipItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../components/TooltipItem */ "./resources/js/components/TooltipItem.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  function Tooltips(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Tooltips).call(this, props));
    _this.toggle = _this.toggle.bind(_assertThisInitialized(_this));
    _this.state = {
  ...
  _createClass(Tooltips, [{
    ...
    value: function toggle(i) {
      this.setState(function (previousState) {
        var newArray = previousState.tooltipOpen.map(function (element, index) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "fa fa-align-justify"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("strong", null, "Tooltip"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("small", null, " list")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["CardBody"], null, tooltips.map(function (tooltip) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_TooltipItem__WEBPACK_IMPORTED_MODULE_2__["default"], {
          key: tooltip.id,
          item: tooltip,
          id: tooltip.id
        });
