        ...
        <div className="card">
          ...
          <div className="card-body">
            <p>
              ...
              want to match the font styling of a heading but cannot use the associated HTML
              element.
            </p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p>
              ...
              content. When you need a heading to stand out, consider using
              a
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p>
              ...
              classes (or semantic mixins). For longer terms, you can
              optionally add a
